...
import com.main.koko_main_api.Dtos.PlayableSaveDto;
...
public class PlayableTest {
    ...
    public void playable_add_bpm_test() {
        System.out.println(System.getenv("KOKO_MAIN_DB_PORT"));
        Playable play = PlayableSaveDto.builder().level(2).build().toEntity();
